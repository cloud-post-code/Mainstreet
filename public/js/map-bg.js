(function () {
  ...
  // Map moves this fraction of scroll progress (0.01 = 100x slower than 1:1)
  var mapSpeedFactor = 0.01;
  ...
  function syncMapToScroll() {
    ...
    // Progress = scroll fraction scaled so map moves 100x slower than scroll
